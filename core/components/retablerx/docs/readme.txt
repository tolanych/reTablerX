...
* mincol - минимальное количество колонок в таблице, при котором к таблице будет применено преобразование.
По-умолчанию - значение заданное в системной настройке retablerx_global_mincol.